...
namespace SqlLib2
{
    public class DapperHelper
    {
        ...
        public DapperHelper(IConfiguration configuration)
        {
            ...
            var connection = _configuration.GetSection("ConnectionStrings:" + ConnectionName);
            _connStr = connection.GetSection("ConnectionString").Value;
            _providerName = connection.GetSection("ProviderName").Value;
        }
        ...
        private DbProviderFactory GetNpgDbType()
        {
        ...
        private IDbConnection CreateDapperNpgConnection()
        {
            IDbConnection conn = GetNpgDbType().CreateConnection();
            if (_connStr == null)
                conn.ConnectionString = _connStr;
            else
                conn.ConnectionString = _connStr;
