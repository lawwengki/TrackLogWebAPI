...
namespace SqlLib2
{
	public class NpgSqlCmdHelper : ISqlCmdHelper
	{
		private List<IDataParameter> _parameters;

		//private List<IDataParameter> _parameters2;

		private readonly int _cmdTimeOut = 60;
		public NpgSqlCmdHelper()
		{
		...
		//public List<string> GetInsertMultipleSqlTxt<T>(T obj,string sModel)
		//{
		...
		//	if (_parameters == null)
		//		_parameters = Object2Parameter(obj,sModel);
		//	string fStr = ""; //欄位字串
		//	string pStr = ""; //參數字串
		//	foreach (var p in _parameters)
		//	{
		...
		//public IDbCommand GetInsertCmd<T>(T obj, string sModel)
		//{
		//	if (_parameters != null)
		//		_parameters = Object2Parameter(obj);
		//	var sqlTxt = GetInsertMultipleSqlTxt(obj, sModel);
		//	return GetCmd(List<sqlTxt>);
		//}
		...
		public List<IDataParameter> Object2Parameter<T>(T obj)
		{
			...
			{
				if (property.GetValue(obj, null) != null && !property.PropertyType.Name.Contains("List"))
				{
					...
					sqlParameter.NpgsqlDbType = NpgSqlDbTypeMap.GetDbType(property.GetValue(obj, null).GetType());
        ...
        //public List<IDataParameter> Object2Parameter2<T>(T obj)
        //{
        //    List<IDataParameter> parameters = new List<IDataParameter>();
        //    foreach (PropertyInfo property in obj.GetType().GetProperties())
        //    {
