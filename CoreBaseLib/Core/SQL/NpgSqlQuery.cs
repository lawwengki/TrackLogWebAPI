...
namespace SqlLib2
{
    public class NpgSqlQuery : NpgSqlBase, IDbQuery
    {

        public readonly IConfiguration _configuration;
        public NpgSqlQuery(IConfiguration configuration) : base(configuration)
        {
            _configuration = configuration;
        }

        public NpgSqlQuery(string connStr, IConfiguration configuration) : base(configuration)
        {
            _configuration = configuration;
            ConnStr = connStr;
        }
